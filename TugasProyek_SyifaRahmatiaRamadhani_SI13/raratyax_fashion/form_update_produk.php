...
$data = $db->query("SELECT * FROM tb_produk WHERE id='$_GET[id]'");
$produk = $data->fetch();
?>
<!DOCTYPE html>
<html lang="en">
                                    ...
                                    <div class="col-md-12 mt-4">
                                        <form method="POST" action="update_produk.php">
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-8">
                                                    <div class="input-group">
                                                        <input id="min_stok" name="min_stok" type="text"
                                                            class="form-control" value="<?= $produk['min_stok'] ?>">
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="form-group row">
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-8">
                                                    <div class="input-group">
                                                        <input id="kategori_produk_id" name="kategori_produk_id" type="text"
                                                            class="form-control" value="<?= $produk['kategori_produk_id'] ?>">
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="form-group row">
