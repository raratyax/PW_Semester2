...
$data = $db->query("SELECT * FROM tb_pesanan WHERE id='$_GET[id]'");
$pesanan = $data->fetch();
?>
<!DOCTYPE html>
<html lang="en">
                                    ...
                                    <div class="col-md-12 mt-4">
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-8">
                                                    <div class="input-group">
                                                        <input id="alamat_pemesan" name="alamat_pemesan" type="text"
                                                            class="form-control" value="<?= $pesanan['alamat_pemesan'] ?>">
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="form-group row">
                                                ...
                                                <div class="col-8">
                                                    <div class="input-group">
                                                        <input id="no_hp" name="no_hp" type="text"
                                                            class="form-control" value="<?= $pesanan['no_hp'] ?>">
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="form-group row">
                                                ...
                                                <div class="col-8">
                                                    <div class="input-group">
                                                        <input id="email" name="email" type="text"
                                                            class="form-control" value="<?= $pesanan['email'] ?>">
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="form-group row">
                                                ...
                                                <div class="col-8">
                                                    <div class="input-group">
                                                        <input id="jumlah_pesanan" name="jumlah_pesanan" type="text"
                                                            class="form-control" value="<?= $pesanan['jumlah_pesanan'] ?>">
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="form-group row">
                                                ...
                                                <div class="col-8">
                                                    <div class="input-group">
                                                        <input id="deskripsi" name="deskripsi" type="text"
                                                            class="form-control" value="<?= $pesanan['deskripsi'] ?>">
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="form-group row">
                                                ...
                                                <div class="col-8">
                                                    <div class="input-group">
                                                        <input id="produk_id" name="produk_id" type="text"
                                                            class="form-control" value="<?= $pesanan['produk_id'] ?>">
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="form-group row">
